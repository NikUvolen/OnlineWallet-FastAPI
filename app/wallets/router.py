...
async def get_wallet_balance(
    wallet_id: UUID, db: AsyncSession = Depends(get_db)
) -> WalletResponse:
...
async def update_wallet_balance(
    wallet_id: UUID, operation: WalletOperation, db: AsyncSession = Depends(get_db)
) -> WalletResponse:
...
async def create_wallet(db: AsyncSession = Depends(get_db)) -> WalletResponse:
    try:
