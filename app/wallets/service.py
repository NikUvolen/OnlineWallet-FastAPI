...
from app.wallets.schemas import OperationType, WalletOperation, WalletResponse


async def get_balance(session: AsyncSession, wallet_id: UUID) -> WalletResponse:
...
async def update_balance(
    session: AsyncSession, wallet_id: UUID, operation: WalletOperation
) -> Wallet:
